...
const PARK_PHOTOS = [
  ...
  { src: '/assets/park-extra-2.png',        label: 'Park Grounds' },
  { src: '/assets/raw-6.jpeg',              label: 'Park Life' },
  { src: '/assets/park-carousel.webp',      label: 'Carousel Rides' },
  { src: '/assets/raw-7.jpeg',              label: 'Outdoors' },
  { src: '/assets/park-bouncer.webp',       label: 'Bouncing Castle' },
  { src: '/assets/raw-8.jpeg',              label: 'Adventure' },
  { src: '/assets/rope-bridge-sky.jpeg',    label: 'Rope Bridge' },
  { src: '/assets/rope-course-group.jpeg',  label: 'Rope Course Group' },
  { src: '/assets/raw-9.jpeg',              label: 'CabHouse' },
  { src: '/assets/pool-kids.jpeg',          label: 'Kids Pool' },
  { src: '/assets/sky-bike-rainbow.jpeg',   label: 'Sky Bike' },
  { src: '/assets/raw-10.jpeg',             label: 'Park' },
  { src: '/assets/team-group.jpeg',         label: 'Group Fun' },
]
