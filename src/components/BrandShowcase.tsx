...
const BRANDS = [
  {
    ...
    desc: 'Games, restaurant, pool, camping, weddings, meetings and conferences — the flagship experience.',
  ...
  },
  {
    ...
    desc: 'Pure, crisp water sourced and bottled right here in Kisii. Bulk or domestic delivery.',
  ...
  },
  {
    ...
    desc: 'Premium short and long-stay furnished apartments with access to all CabHouse amenities.',
